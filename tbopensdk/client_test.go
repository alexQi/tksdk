...
import (
	"alexQi/tksdk/tbopensdk/response/tbkdgmaterialoptionalupgrade"
	"alexQi/tksdk/tbopensdk/response/tbkdgmaterialrecommend"
	"encoding/json"
	"fmt"
	"io/ioutil"
	"os"
	...
	"alexQi/tksdk/tbopensdk/response/taobaotbkitemidprivatetransform"
	"alexQi/tksdk/tbopensdk/response/taobaotbkiteminfoupgradeget"
	"alexQi/tksdk/tbopensdk/response/taobaotbkscadzonecreate"
	"alexQi/tksdk/tbopensdk/response/taobaotbkscgenerallinkconvert"
	"alexQi/tksdk/tbopensdk/response/taobaotbkscmaterialoptionalupgrade"
	"alexQi/tksdk/tbopensdk/response/taobaotbkscmaterialrecommend"

	request2 "alexQi/tksdk/tbopensdk/request"
	"alexQi/tksdk/tbopensdk/response/juitemssearch"
	"alexQi/tksdk/tbopensdk/response/sellercatslistget"
	"alexQi/tksdk/tbopensdk/response/shopcatslistget"
	"alexQi/tksdk/tbopensdk/response/shopgetbytitle"
	"alexQi/tksdk/tbopensdk/response/taobaotbkitemclickextract"
	"alexQi/tksdk/tbopensdk/response/taobaotbkscrelationrefund"
	"alexQi/tksdk/tbopensdk/response/taobaotbksctpwdconvert"
	"alexQi/tksdk/tbopensdk/response/tbkactivitylinkget"
	"alexQi/tksdk/tbopensdk/response/tbkcouponget"
	"alexQi/tksdk/tbopensdk/response/tbkdgitemcouponget"
	"alexQi/tksdk/tbopensdk/response/tbkdgmaterialoptional"
	"alexQi/tksdk/tbopensdk/response/tbkdgnewuserorderget"
	"alexQi/tksdk/tbopensdk/response/tbkdgnewuserordersum"
	"alexQi/tksdk/tbopensdk/response/tbkdgoptimusmaterial"
	"alexQi/tksdk/tbopensdk/response/tbkdgvegastljcreate"
	"alexQi/tksdk/tbopensdk/response/tbkitemconvert"
	"alexQi/tksdk/tbopensdk/response/tbkitemcouponget"
	"alexQi/tksdk/tbopensdk/response/tbkitemget"
	"alexQi/tksdk/tbopensdk/response/tbkiteminfoget"
	"alexQi/tksdk/tbopensdk/response/tbkitemrecommendget"
	"alexQi/tksdk/tbopensdk/response/tbkjutqgget"
	"alexQi/tksdk/tbopensdk/response/tbkprivilegeget"
	"alexQi/tksdk/tbopensdk/response/tbkscactivityinfoget"
	"alexQi/tksdk/tbopensdk/response/tbkscactivitylinktoolget"
	"alexQi/tksdk/tbopensdk/response/tbksccouponbrandrecommend"
	"alexQi/tksdk/tbopensdk/response/tbksccouponrealtimerecommend"
	"alexQi/tksdk/tbopensdk/response/tbkscinvitecodeget"
	"alexQi/tksdk/tbopensdk/response/tbkscmaterialoptional"
	"alexQi/tksdk/tbopensdk/response/tbkscoptimusmaterial"
	"alexQi/tksdk/tbopensdk/response/tbkscorderget"
	"alexQi/tksdk/tbopensdk/response/tbkscpublisherinfoget"
	"alexQi/tksdk/tbopensdk/response/tbkscpublisherinfosave"
	"alexQi/tksdk/tbopensdk/response/tbkscshopconvert"
	"alexQi/tksdk/tbopensdk/response/tbkshopconvert"
	"alexQi/tksdk/tbopensdk/response/tbkshopget"
	"alexQi/tksdk/tbopensdk/response/tbkspreadget"
	"alexQi/tksdk/tbopensdk/response/tbktpwdconvert"
	response2 "alexQi/tksdk/tbopensdk/response/tbktpwdcreate"
)
