...
import (
	"alexQi/tksdk/jdopensdk/request"
	"alexQi/tksdk/jdopensdk/response/jdunionopencoupongiftget"
	"alexQi/tksdk/jdopensdk/response/jdunionopencoupongiftstop"
	"alexQi/tksdk/jdopensdk/response/jdunionopengoodsjingfenquery"
	"alexQi/tksdk/jdopensdk/response/jdunionopengoodspromotiongoodsinfoquery"
	"alexQi/tksdk/jdopensdk/response/jdunionopengoodsquery"
	"alexQi/tksdk/jdopensdk/response/jdunionopenorderrowquery"
	"alexQi/tksdk/jdopensdk/response/jdunionopenpositioncreate"
	"alexQi/tksdk/jdopensdk/response/jdunionopenpositionquery"
	"alexQi/tksdk/jdopensdk/response/jdunionopenpromotionbysubunionidget"
	"alexQi/tksdk/jdopensdk/response/jdunionopenpromotioncommonget"
	"alexQi/tksdk/jdopensdk/response/jdunionopenstatisticsgiftcouponquery"
	"encoding/json"
	"fmt"
	"io/ioutil"
	"os"
